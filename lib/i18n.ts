...
export const ui = {
  ...
  en: {
    ...
    drivers: {
      ...
      text: "At Limo Egypt, we understand that the driver is the face of the company and entrusted with your safety. Therefore, we select our team with extreme care and subject them to regular training to ensure the highest levels of safety, professionalism, and courtesy throughout your trip.",
