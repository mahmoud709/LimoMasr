...
export async function POST(request: Request) {
  ...
  const booking: Booking = {
    ...
    isForOther: Boolean(payload.isForOther),
    otherPersonName: payload.otherPersonName ?? undefined,
    otherPersonPhone: payload.otherPersonPhone ?? undefined,
    otherPersonLocation: payload.otherPersonLocation ?? undefined,
    status: "new",
