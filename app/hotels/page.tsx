...
import { getSiteSettings, getHotels } from "@/lib/data";
...
export default async function HotelsPage({ searchParams }: { searchParams?: Promise<{ __locale?: string }> }) {
  const [searchParamsResolved, settings, hotels] = await Promise.all([
  ...
  return (
    <PublicLayout settings={settings} whatsappType="hotel" locale={locale}>
      <main className="mx-auto w-full relative z-10 flex flex-col pt-32 overflow-x-hidden">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] animate-reveal-2 px-6 md:px-8 max-w-7xl mx-auto w-full pb-16">
          <section className="flex flex-col gap-8 h-full">
            <div className="luxury-panel p-6 md:p-10 flex flex-col justify-center h-full relative overflow-hidden group border-white/20">
              ...
              <CinematicBackground images={[
                "https://images.unsplash.com/photo-1542314831-c6a4d14d8373?q=80&w=2000&auto=format&fit=crop",
                "https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=2000&auto=format&fit=crop",
                "https://images.unsplash.com/photo-1551882547-ff40c0d589rx?q=80&w=2000&auto=format&fit=crop"
              ]} />
