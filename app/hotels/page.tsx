    ...
    <PublicLayout settings={settings} whatsappType="hotel">
      <main className="mx-auto w-full relative z-10 flex flex-col pt-32">
        <div className="animate-reveal-1 px-8 max-w-7xl mx-auto w-full">
          <SectionHeader eyebrow="حجز فنادق" title="اطلب عرض إقامة حسب المدينة" text="أرسل تاريخ الوصول والمغادرة وعدد الأفراد، وسيتم تأكيد التفاصيل عبر واتساب." />
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] animate-reveal-2 px-8 max-w-7xl mx-auto w-full pb-16">
          ...
          <div className="luxury-panel p-8 h-fit sticky top-32">
            <BookingForm type="hotel" serviceRefId="hotel-request" serviceName="طلب حجز فندق" whatsappNumber={settings.whatsappServiceNumber} />
          </div>
        </div>
