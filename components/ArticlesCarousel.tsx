      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16 relative z-10">
        ...
        <div className="flex flex-row items-center justify-between md:justify-end gap-4 md:gap-6 w-full md:w-auto">
          ...
          <div className="flex items-center gap-2 shrink-0" dir="ltr">
            <button onClick={() => scroll(isEn ? "prev" : "next")} className="w-10 h-10 rounded-full border border-black/10 flex items-center justify-center hover:bg-[#1a2b3c] hover:border-[#1a2b3c] hover:text-[#d0a755] transition-all text-[#1a2b3c]">
               <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            </button>
            <button onClick={() => scroll(isEn ? "next" : "prev")} className="w-10 h-10 rounded-full border border-black/10 flex items-center justify-center hover:bg-[#1a2b3c] hover:border-[#1a2b3c] hover:text-[#d0a755] transition-all text-[#1a2b3c]">
